...
/// A class that provides synchronous, queue-safe (thread-safe) access to a `value` with selected `commands` execution priority.
public class QueueSafeSyncedPrioritisedValue<Value>: QueueSafeValueConcrete<Value> {
...
//     */
//    required public init(value: Value, priority: ValueContainer<Value>.PerformPriority) {
